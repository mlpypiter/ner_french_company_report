...
sys.path.append('../anonymisation-master/match_text_unsafe')
sys.path.append('../anonymisation-master/match_text')
sys.path.append('../anonymisation-master/misc')
from spacy.tokens.span import Span

from match_acora import AcoraMatcher
from match_address import find_address_in_block_of_paragraphs
from normalize_offset import normalize_offsets
